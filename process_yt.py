...
API_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIzZjEwMDExNzRAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.LXXNwJkTo3Ue0j-V7WaVUAE5_TW8yKCOFhzFhyZzSt0"
...
def correct_transcript(transcript):
    ...
    data = {
        ...
        "messages": [
            {
                "role": "user",
                "content": "correct this transcript: "
                + transcript
                + " return only the answer and nothing else , not extra text",
            }
        ],
    }
